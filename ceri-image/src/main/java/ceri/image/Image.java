...
/**
 * Encapsulates an image that can have operations applied to it. Underlying implementations exist
 * for Java2d BufferedImage and ImageMagick processing. Image is immutable, so every operation
...
public interface Image {
	...
	/**
	 * Writes image to an output stream in given format. Quality value is 0.0 (lowest) to 1.0
	 * (highest).
	 */
