...
public class WriteDataBehavior {
	...
	public void shouldReadAddressFromInput() {
		assertThat(write.readAddressFrom(in(0x04, 0x66)), is(Address.from("A1")));
	}
