...
/**
 * OperationTimedOutException is an exception to be thrown when an operation
 * times out.
 * 
 * 
...
public class OperationTimedOutException extends Exception {
	private static final long serialVersionUID = 1343481547235726620L;

	/**
	 * OperationTimedOutException constructs an OperationTimedOutException with
	 * no message
	 * 
	 * 
	 */
