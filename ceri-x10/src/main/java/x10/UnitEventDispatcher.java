 ...
 * UnitListener when an event comes in. This object is single-threaded, so all
 * UnitListeners are notified by the same thread. This is important to note so
 * that UnitListeners do not "hog" the thread. UnitListeners should quickly
 * return from handling events as to not delay subsequent listeners from
 * receiving the event. <BR>
 * <BR>
 * 
...
public class UnitEventDispatcher extends Thread {
	...
	/**
	 * dispatchUnitEvent adds the specified UnitEvent to the queue of events to
	 * be dispatched.
	 * 
	 * @param event
	...
	/**
	 * addUnitListener adds the specified UnitListener to the list of listeners
	 * that are notified by the dispatcher.
	 * 
	 * @param listener
	 *            the listener to add.
	 */
	...
	/**
	 * removeUnitListener removes the specified listener. This cuts the
	 * specified listener off from receiving any subsequent events.
	 * 
	 * @param listener
