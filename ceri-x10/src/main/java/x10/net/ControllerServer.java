...
public class ControllerServer extends Thread {
	...
	/**
	 * ControllerServer constructs a new ControllerServer network daemon which
	 * provides access to the specified Controller on the specified port.
	 * 
	 * @param c
	 ...
	 * Each connection gets its own ServerDispatchProxy.
	 * 
