 ...
 * a ControllerServer via TCP socket.
 * 
 * 
...
public class SocketController implements Runnable, Controller {
	 ...
	 * 
	 * @param host
	 *            the hostname or IP address of the server that is hosting the
	 *            ControllerServer.
	 * @param port
	 *            the port that the ControllerServer is listening on.
	 * @exception IOException
	 *                thrown if an error occurs setting up the streams to/from
	...
	/**
	 * addCommand adds a Command to be queued and then dispatched to the
	 * ControllerServer
	 * 
	 * @param command
