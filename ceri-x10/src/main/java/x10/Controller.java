 ...
 * Commands to ALL registered x10 hardware and software modules. A Controller
 * must also handle the addition and removal of UnitListeners.
 * 
 * 
...
public interface Controller extends Closeable {
	 ...
	 * events that occur, whether initiated by hardware or software control
	 * modules.
	 * 
	 * @param listener
	 *            the object to recieve UnitEvent objects.
	 * @see x10.UnitEvent
	 */
	...
	/**
	 * removeUnitListener unregisters the specified UnitListener. If the
	 * specified UnitListener isn't registered, then it is ignored.
	 * 
	 * @param listener
	...
	/**
	 * addCommand adds a Command to the queue to be dispatched to all hardware
	 * and software x10 modules.
	 * 
	 * @param command
