...
/**
 * UnitListener is the interface implemented by objects that wish to recieve
 * UnitEvents. This interface is typically implemented by software-based x10
 * modules. A registered UnitListener will recieve ALL events for ALL housecodes
 * and unitcodes. It is up to the implementing class to filter out the events
 * for specific housecodes and unitcodes if desired.
 * 
 * 
...
public interface UnitListener {
	 ...
	 * 
	 * @param event
	 *            the UnitEvent that is dispatched.
	 * 
	 */
