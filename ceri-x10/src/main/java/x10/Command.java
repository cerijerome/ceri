...
/**
 * Command represents an x10 command. This class encapsulates the house code,
 * unit code, function, and optionally the level value for the command.<BR>
 * <BR>
 * 
 * An instance of this class may be constructed and posted to a Controller to
 * have the command executed.<BR>
 * <BR>
 * 
...
public class Command implements Serializable {
	...
	/**
	 * ALL_LIGHTS_ON byte - the x10 function "All Lights On". This function
	 * turns all x10 light modules on.
	 * 
	 * @serial
	 */
	...
	/**
	 * ON byte - the x10 function "On". This function turns the specified module
	 * on.
	 * 
	 * @serial
	 */
	...
	/**
	 * OFF byte - the x10 function "Off". This function turns the specified
	 * module off.
	 * 
	 * @serial
	 */
	...
	/**
	 * DIM byte - the x10 function "Dim". This function dims the specified
	 * module to the specified level.
	 * 
	 * @serial
	 */
	...
	/**
	 * BRIGHT byte - the x10 function "Bright". This function brightens the
	 * specified module to the specified level.
	 * 
	 * @serial
	 */
	...
	/**
	 * ALL_LIGHTS_OFF byte - the x10 function "All Lights Off". This function
	 * turns all x10 light modules off.
	 * 
	 * @serial
	 */
	 ...
	 * is recommended that instances of this class be constructed with one of
	 * the String-parameter-based constructors.
	 * 
	 * @param address
	 *            an x10 module's housecode and unitcode in "CM11A" protocol
	 *            format.
	 * @param function
	...
	/**
	 * Command constructs a Command object with the specified address, function,
	 * and level. This constructor is typically only called by a Controller. It
	 * is recommended that instances of this class be constructed with one of
	 * the String-parameter-based constructors.
	 * 
	 * @param address
	...
	/**
	 * Command constructs a Command object with the specified address and
	 * function. The address must be specified as a two-character String of the
	 * formmat [HouseCode][UnitCode] (ie. "A1"). The function must be one of the
	 * constant functions that are described above.
	 * 
	 * @param address
	 ...
	 *                thrown if either parameter is invalid. An address is
	 *                illegal if the housecode is greater than 'P' or if the
	 *                unitcode is greater than 16. The function is illegal if it
	 *                is not one of the functions listed as a constant (listed
	 *                above).
	 * 
	 */
	...
	/**
	 * Command constructs a Command object with the specified address, function,
	 * and level. The address must be specified as a two-character String of the
	 * formmat [HouseCode][UnitCode] (ie. "A1"). The function must be one of the
	 * constant functions that are described above. The level is a percentage
	 ...
	 * @return boolean - true if the address is a valid x10 address, false
	 *         otherwise
	 * 
	 */
	...
	/**
	 * setAddress sets the housecode and unitcode of this command based on the
	 * specified address.
	 * 
	 * @param address
	 *            a housecode and unitcode as a two-character String
	...
	public void setAddress(String address) throws IllegalArgumentException {
		...
		if ((housecode > 15) || (unitcode > 15) || (housecode < 0) || (unitcode < 0)) {
			throw new IllegalArgumentException("No such device: " + address);
		}
		this.address =
			(short) ((ADDRESS << 8) | (ADDRESS_CODES[housecode] << 4) | (ADDRESS_CODES[unitcode]));
	 ...
	 *            a valid function constant (listed above).
	 * @exception IllegalArgumentException
	 *                thrown if the specified function is not one of the
	 *                constant functions listed above.
	 * 
	 */
	 ...
	 *            the percentage by which the level should change.
	 * @exception IllegalArgumentException
	 *                if the specified function is not one of the constant
	...
	/**
	 * getAddress returns the x10 address in ready-to-send "CM11A" protocol
	 * format.
	 * 
	...
	/**
	 * getFunction returns the x10 function in ready-to-send "CM11A" protocol
	 * format.
	 * 
	...
	/**
	 * getUnitCode returns the unitcode as an integer. The returned unitcode is
	 * always between 1 and 16 inclusive.
	 * 
	...
	/**
	 * getLevel returns the level associated with this Command. This level is
	 * always positive and between 0 and 100 inclusive. The level is modified by
	 * weather the function is a Dim or Bright.
	 * 
	...
	/**
	 * getAddress returns a String-based x10 address as a [HouseCode][UnitCode]
	 * two-character String, based on the specified address in x10 "CM11A"
	 * protocol format.
	 * 
	 * @param address
	...
	/**
	 * getFunction returns the function as a constant (specified above), based
	 * on the specified function in x10 "CM11A" protocol format.
	 * 
	 * @param function
