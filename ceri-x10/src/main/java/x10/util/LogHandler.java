 ...
 * application events. The properties to configure this object are given by the
 * x10/util/LogHandler.ini file. By default, this file should contain:<br>
 * <br>
 * 
 * <code><blockquote>
...
public class LogHandler {
	...
	private LogHandler() {
		...
		if ((logFile == null) || (logFile.trim().length() == 0)) {
			...
			try {
				...
				System.out.println("Error opening \"" + logFile +
					"\" for writing.  Using default instead.");
				out = System.out;
			}
		}
	}
	 ...
	 *            - the message to log
	 * @param minimumLevel
	 *            - the minimum log level that must be set for this message to
	 *            actually be logged.
	 * 
	 */
	 ...
	 * @param minimumLevel
	 *            - the minimum log level that must be set for this exception to
	 *            actually be logged.
	 * 
	 */
	...
	/**
	 * getLogHandler obtains the system's singleton LogHandler that is shared by
	 * all systems.
	 * 
	...
	/**
	 * logException outputs the stack trace of the pecified exception to the
	 * log.
	 * 
	 * @param exception
	 *            - the exception to log the stack trace of.
