...
/**
 * ThreadSafeQueue this is an implementation of a First In First Out (FIFO) data
 * structure. This class uses synchronization to provide thread safety for
 * adding and removing objects to and from the queue. All of the methods in this
 * class are synchronized, therefore temporary thread blocking might occur when
...
public class ThreadSafeQueue {
	...
	/**
	 * dequeueNextAvailable blocks until the next object becomes available to
	 * the queue. If the queue is not empty, the first object is removed from
	 * the queue and returned without blocking.
	 * 
	 * @return Object - the next available object in the queue.
	 * @exception InterruptedException
	 *                if the blocked thread is interrupted before an object
	 *                becomes available.
	 * 
	 */
	...
	/**
	 * peek returns the next available object in the queue without physically
	 * removing the object from the queue.
	 * 
	 * @return Object the next available object in the queue or null if the
	 *         queue is empty.
	 * 
	 */
	...
	/**
	 * dequeue removes the specified object from the queue if and only if the
	 * specified object is the first object in the queue.
	 * 
	 * @param toDequeue
