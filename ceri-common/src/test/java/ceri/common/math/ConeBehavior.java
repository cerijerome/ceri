...
public class ConeBehavior {
	private final Cone c0 = new Cone(2, 8);
	private final Cone c1 = new Cone(4, 1);

	@Test
	public void shouldNotBreachEqualsContract() {
		exerciseEquals(c0, new Cone(2, 8));
		assertNotEquals(c0, new Cone(1.9, 8));
		assertNotEquals(c0, new Cone(2, 8.1));
	}

	@Test
	public void shouldOnlyAllowPositiveAxes() {
		assertException(() -> new Cone(0, 2));
		assertException(() -> new Cone(4, 0));
	}
