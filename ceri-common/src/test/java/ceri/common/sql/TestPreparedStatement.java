...
public class TestPreparedStatement implements PreparedStatement {
	...
	protected TestPreparedStatement() {}
	...
	public void setObject(int parameterIndex, Object x, int targetSqlType) throws SQLException {
		setObject.accept(Arrays.asList(parameterIndex, x, targetSqlType), SQL_ADAPTER);
	}

	@Override
	public void setObject(int parameterIndex, Object x) throws SQLException {
		setObject.accept(Arrays.asList(parameterIndex, x), SQL_ADAPTER);
	}
