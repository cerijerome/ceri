...
public class TimeSpecBehavior {
	...
	public void shouldProvideTimeUnitValues() {
		...
		overflow(() -> new TimeSpec(123, Integer.MAX_VALUE + 1L).nanosInt());
		overflow(() -> new TimeSpec(Integer.MAX_VALUE + 1L, 0).secondsInt());
	}
	...
	public void shouldProvideTotalTimeUnitValues() {
		...
		overflow(() -> new TimeSpec(9223372036L, 854775808L).totalNanos());
	}
