...
public class VersionBehavior {
	...
	public void shouldProvideStringRepresentation() {
		Assert.string(v1, "1");
		Assert.string(v1_2, "1.2");
		Assert.string(v1__2, "1.2");
		Assert.string(v1___y, "1.y");
		Assert.string(v1_1__x, "1.1.x");
		Assert.string(v1__1_x, "1.1.x");
		Assert.string(v1_1_1_x, "1.1.1.x");
	}
	...
	public void shouldCompare() {
		...
		Assert.ordered(list, v1, v1___x, v1___y, v1__1, v1__1_x, v1__2, v1_1, v1_1__x, v1_1_1,
			v1_1_1_x, v1_1_2, v1_2);
	}

	@Test
	public void shouldCreateFromKernelValue() {
		Assert.equal(Version.kernel(0x1234567), new Version(0x123, 0x45, 0x67, null));
	}

	@Test
	public void shouldProvideKernelValue() {
		Assert.equal(v1.kernel(), 0x10000);
		Assert.equal(v1_1__x.kernel(), 0x10100);
		Assert.equal(v1__1_x.kernel(), 0x10001);
		Assert.equal(v1_1_1_x.kernel(), 0x10101);
	}
