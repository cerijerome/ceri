...
public class IntFieldBehavior {

	static class Holder {
		static final IntField.Typed<Holder> iAcc =
			IntField.typed(h -> h.iVal, (h, i) -> h.iVal = i);
		static final IntField.Typed<Holder> sAcc =
			IntField.typedUshort(h -> h.sVal, (h, s) -> h.sVal = s);
		static final IntField.Typed<Holder> bAcc =
			IntField.typedUbyte(h -> h.bVal, (h, b) -> h.bVal = b);
	...
	public void shouldFailForNullAccessors() {
		assertThrown(() -> IntField.of(null, null).get());
		assertThrown(() -> IntField.of(null, null).set(0));
	}

	@Test
	public void shouldFailForNullTypedAccessors() {
		assertThrown(() -> IntField.typed(null, null).get(""));
		assertThrown(() -> IntField.typed(null, null).set("", 0));
	}

	@Test
	public void shouldSetMaskedValues() {
		Holder h = new Holder();
		IntField iAcc = Holder.iAcc.from(h);
		iAcc.set(0x1234);
	...
	public void shouldProvideGetOnlyAccess() {
		int[] x = { 7 };
		IntField accessor = IntField.getter(() -> x[0]);
	...
	public void shouldProvideSetOnlyAccess() {
		int[] x = { 7 };
		IntField accessor = IntField.setter(i -> x[0] = i);
		accessor.set(0);
		assertEquals(x[0], 0);
	...
	public void shouldAccessIntegerFields() {
		...
		IntField.Typed<Holder> iAcc = IntField.typed(t -> t.iVal, null);
	...
	public void shouldAccessShortFields() {
		...
		IntField.Typed<Holder> sAcc = IntField.typedUshort(t -> t.sVal, null);
	...
	public void shouldAccessByteFields() {
		...
		IntField.Typed<Holder> bAcc = IntField.typedUbyte(t -> t.bVal, null);
	...
	public void shouldProvideInstanceAccessorFromTypedAccessor() {
		Holder h = new Holder();
		IntField i = Holder.iAcc.from(h);
		IntField s = Holder.sAcc.from(h);
		IntField b = Holder.bAcc.from(h);
		i.set(0xffffff);
		s.set(0);
		s.set(0xffff);
