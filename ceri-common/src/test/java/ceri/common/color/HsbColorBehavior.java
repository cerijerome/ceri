...
public class HsbColorBehavior {
	...
	public void shouldConvertToColor() {
		assertThat(HsbColor.of(0.0, 0.0, 1.0).asColor(), is(Color.white));
		assertThat(HsbColor.of(0.5, 0.0, 1.0).asColor(), is(Color.white));
		assertThat(HsbColor.of(1.0, 0.0, 1.0).asColor(), is(Color.white));
		assertThat(HsbColor.of(0.0, 0.0, 0.0).asColor(), is(Color.black));
		assertThat(HsbColor.of(0.5, 0.0, 0.0).asColor(), is(Color.black));
		assertThat(HsbColor.of(1.0, 0.0, 0.0).asColor(), is(Color.black));
		assertThat(HsbColor.of(0.0, 1.0, 1.0).asColor(), is(Color.red));
		assertThat(HsbColor.of(0.33333, 1.0, 1.0).asColor(), is(Color.green));
		assertThat(HsbColor.of(0.66667, 1.0, 1.0).asColor(), is(Color.blue));
		assertThat(HsbColor.of(0.16667, 1.0, 1.0).asColor(), is(Color.yellow));
		assertThat(HsbColor.of(0.5, 1.0, 1.0).asColor(), is(Color.cyan));
		assertThat(HsbColor.of(0.83333, 1.0, 1.0).asColor(), is(Color.magenta));
	}
