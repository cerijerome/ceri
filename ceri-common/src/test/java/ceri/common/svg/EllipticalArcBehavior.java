...
public class EllipticalArcBehavior {
	...
	public void shouldReflect() {
		...
		assertD(e, "A4,1 0 0,1 1,1");
		assertD(e.reflect(line), "A4,1 0 0,0 1,-1");
	}
	...
	public void shouldScale() {
		var e = EllipticalArc.of(Position.absolute(1, 1), Size2d.of(4, 1));
		assertD(e, "A4,1 0 0,1 1,1");
		assertD(e.scale(Ratio2d.uniform(0.5)), "A2,0.5 0 0,1 0.5,0.5");
	}
	...
	public void shouldTranslate() {
		var e = EllipticalArc.of(Position.absolute(1, 1), Size2d.of(4, 1));
		assertD(e, "A4,1 0 0,1 1,1");
		assertD(e.translate(Point2d.of(-1, -1)), "A4,1 0 0,1 0,0");
	}

	@Test
	public void shouldRotate() {
		var e = EllipticalArc.of(Position.ABSOLUTE_ZERO, Size2d.of(4, 1));
		assertD(e, "A4,1 0 0,1 0,0");
		assertD(e.rotate(0), "A4,1 0 0,1 0,0");
		assertD(e.rotate(90), "A4,1 90 0,1 0,0");
		assertD(e.rotate(-60), "A4,1 -60 0,1 0,0");
	}

	@Test
	public void shouldReverse() {
		assertD(EllipticalArc.of(Position.relative(0, 1), Size2d.of(2, 1)).reverse(),
			"a2,1 0 0,0 0,-1");
	}
}
