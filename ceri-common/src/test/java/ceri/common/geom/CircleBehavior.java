...
public class CircleBehavior {
	...
	public void shouldCalculateRadiusFromArea() {
		assertApprox(Circle.radiusFromArea(50.265), 4);
		assertApprox(Circle.radiusFromArea(3.142), 1);
	...
	public void shouldCalculateCircumference() {
		...
		assertApprox(Circle.circumference(4), 25.133);
	}
	...
	public void shouldCalculateArea() {
		...
		assertApprox(Circle.area(1), 3.142);
	}
