...
public class AnsiEscape {
	...
	public static class Sgr extends Escaper {
		...
		public Sgr fgColor8(int r, int g, int b) {
			Validate.range(r, 0, 5);
			Validate.range(g, 0, 5);
			Validate.range(b, 0, 5);
		...
		public Sgr fgColor24(int r, int g, int b) {
			Validate.range(r, 0, Colors.MAX_VALUE);
			Validate.range(g, 0, Colors.MAX_VALUE);
			Validate.range(b, 0, Colors.MAX_VALUE);
