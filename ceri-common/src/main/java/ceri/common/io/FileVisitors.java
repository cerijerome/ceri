...
public class FileVisitors {
	 ...
	 */
	public static <T> Excepts.BiFunction<IOException, Path, T, FileVisitResult> deletion() {
		return (path, _) -> {
			Files.delete(path);
			return result(true);
		};
	 ...
	 */
	public static <T> Excepts.BiFunction<IOException, T, IOException, FileVisitResult>
		ignoreOnFail() {
	 ...
	 * callbacks.
	 */
	public static <T, U> Excepts.BiFunction<IOException, T, U, FileVisitResult>
		adapt(Excepts.Function<IOException, T, FileVisitResult> fn) {
	 ...
	 */
	public static <T, U> Excepts.BiFunction<IOException, T, U, FileVisitResult>
		adaptBiPredicate(Excepts.BiPredicate<IOException, T, U> test) {
	 ...
	 */
	public static <T, U> Excepts.BiFunction<IOException, T, U, FileVisitResult>
		adaptPredicate(Excepts.Predicate<IOException, T> test) {
	 ...
	 */
	public static <T, U> Excepts.BiFunction<IOException, T, U, FileVisitResult>
		adaptBiConsumer(Excepts.BiConsumer<IOException, T, U> consumer) {
		return (t, u) -> {
			consumer.accept(t, u);
			return result(true);
		};
	 ...
	 */
	public static <T, U> Excepts.BiFunction<IOException, T, U, FileVisitResult>
		adaptConsumer(Excepts.Consumer<IOException, T> consumer) {
		return (t, _) -> {
			consumer.accept(t);
			return result(true);
		};
	 ...
	 */
	public static <T> FileVisitor<T> ofDir(Excepts.Consumer<IOException, T> dirFn) {
	 ...
	 * Visitor to be used with Files.walkFileTree, checking path and attributes.
	 */
	public static <T> FileVisitor<T> ofFile(Excepts.Consumer<IOException, T> fileFn) {
	...
	public static <T> FileVisitor<T> of(
		Excepts.BiFunction<IOException, T, BasicFileAttributes, FileVisitResult> preDirFn,
		Excepts.BiFunction<IOException, T, IOException, FileVisitResult> postDirFn,
		Excepts.BiFunction<IOException, T, BasicFileAttributes, FileVisitResult> fileFn) {
	...
	public static <T> FileVisitor<T> of(
		...
		Excepts.BiFunction<IOException, T, IOException, FileVisitResult> postDirFn,
		Excepts.BiFunction<IOException, T, BasicFileAttributes, FileVisitResult> fileFn,
		Excepts.BiFunction<IOException, T, IOException, FileVisitResult> failedFileFn) {
