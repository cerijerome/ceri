...
public class IncompleteIoException extends IOException {
	...
	public static IncompleteIoException of(int actual, int expected, String message, Throwable cause) {
		return new IncompleteIoException
			(actual, expected, message, cause);
	}
