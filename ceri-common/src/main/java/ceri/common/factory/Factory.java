...
/**
 * Interface for a class that will construct an object of type T from an object of type F. The same
 * constructor can be used for subtypes of T and supertypes of F.
 */
