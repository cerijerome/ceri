 ...
 */
public record Xyz(double a, double x, double y, double z) {

	public static final Xyz CIE_A = of(1.09850, 1.0, 0.35585);
	public static final Xyz CIE_B = of(0.99072, 1.0, 0.85223);
	public static final Xyz CIE_C = of(0.98074, 1.0, 1.18232);
	public static final Xyz CIE_D50 = of(0.96422, 1.0, 0.82521);
	public static final Xyz CIE_D55 = of(0.95682, 1.0, 0.92149);
	public static final Xyz CIE_D65 = of(0.95047, 1.0, 1.08883);
	public static final Xyz CIE_D75 = of(0.94972, 1.0, 1.22638);
	public static final Xyz CIE_E = of(1.0, 1.0, 1.0);
	public static final Xyz CIE_F2 = of(0.99186, 1.0, 0.67393);
	public static final Xyz CIE_F7 = of(0.95041, 1.0, 1.08747);
	public static final Xyz CIE_F11 = of(1.00962, 1.0, 0.64350);

	/**
	 * Construct from sRGB color. Alpha is maintained.
	 */
	public static Xyz from(Color color) {
	 ...
	 */
	public static Xyz fromRgb(int rgb) {
	 ...
	 */
	public static Xyz from(int argb) {
	...
	public static Xyz of(double x, double y, double z) {
		return new Xyz(Colors.MAX_RATIO, x, y, z);
	}

	/**
	 * Construct from alpha + CIE XYZ 0-1 values.
	 */
	public static Xyz of(double a, double x, double y, double z) {
		return new Xyz(a, x, y, z);
	}
	 ...
	 */
	public Luv.Ref luvRef() {
		return Luv.Ref.from(x, y, z);
	}
