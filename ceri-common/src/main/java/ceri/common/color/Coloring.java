...
public enum Coloring {
	...
	private static final Map<Integer, Coloring> argbLookup = Enums.map(c -> c.argb, Coloring.class);
	private static final Map<String, Coloring> nameLookup =
		Enums.map(t -> t.name().toLowerCase(), Coloring.class);
	 ...
	 * Lookup by name.
	 */
	public static Coloring from(String name) {
	 ...
	 */
	public static Coloring from(Color color) {
	 ...
	 */
	public static Coloring from(int rgb) {
		return argbLookup.get(Colors.argb(rgb));
	}

	/**
	 * Provide a random entry.
	 */
	public static Coloring random() {
		return Enums.random(Coloring.class);
	}
