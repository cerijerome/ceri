...
public class Shape3dUtil {
	...
	public static Radial3d invert(Radial3d radial) {
		return InvertedRadial3d.create(radial);
	}

	public static Radial3d truncate(Radial3d radial, double h0, double h) {
	 ...
	 * gradient m at r1.
	 */
	public static Radial3d spheroidFromGradient(double r0, double r1, double h, double m) {
		return m > 0 ? fromPositiveGradient(r0, r1, h, m) : fromNegativeGradient(r0, r1, h, m);
	}
	 ...
	 */
	public static Radial3d truncatedSpheroid(double r, double c, double h0, double h) {
		Spheroid3d spheroid = Spheroid3d.create(r, c);
		if (h0 == 0 && h == c) return spheroid;
		return truncate(spheroid, h0, h);
	}

	private static Radial3d fromPositiveGradient(double r0, double r1, double h, double m) {
	...
	private static Radial3d fromNegativeGradient(double r0, double r1, double h, double m) {
