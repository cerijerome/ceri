...
import ceri.ffm.core.IntType;
import ceri.ffm.core.Layouts;
import ceri.ffm.core.Native;
import ceri.ffm.core.IntType.size_t;
import ceri.ffm.core.IntType.ssize_t;
...
public class CUnistd {
	...
	@IntType.Config(value = "size_t", unsigned = true)
	public static class size_t extends IntType<size_t> {}

	@SuppressWarnings("serial")
	@IntType.Config(value = "size_t", unsigned = false)
	...
	//
	// /**
	// * Creates a unidirectional data channel. The returned array contains the read [0] and write
	// [1]
	...
	//
	// /**
	// * Reads bytes into a new buffer and copies to the byte array. Returns the number of bytes
	// read,
	...
	// * or 0 on EAGAIN/EWOULDBLOCK (with O_NONBLOCK) and EINTR errors. The length must not be
	// larger
	...
	//
	// /**
	// * Reads up to length bytes into the buffer and copies to the byte array. Returns the number
	// of
	...
	//
	// /**
	// * Reads up to length bytes into a new buffer and returns a new byte array. Returns empty
	// array
	...
	//
	// /**
	// * Reads up to length bytes into the buffer and returns a new byte array. Returns empty array
	// on
	// * EAGAIN/EWOULDBLOCK (with O_NONBLOCK) and EINTR errors.
	// */
	...
	//
	// /**
	// * Calls read() incrementally over the buffer, until length bytes are read, or read() returns
	// 0.
	...
	//
	// /**
	// * Calls read() incrementally over a new buffer, until length bytes are read, or read()
	// returns
	...
	//
	// /**
	// * Calls read() incrementally over a new buffer, until all bytes are read, or read() returns
	// 0.
	...
	// * Calls read() incrementally over a new buffer, until length bytes are read, or read()
	// returns
	// * 0. Copies bytes from the buffer to the array. May block without O_NONBLOCK. Returns the
	// total
	// * number of bytes read.
	// */
	...
	//
	// /**
	// * Calls read() in batches incrementally over the buffer, until length bytes are read, or
	// read()
	// * returns 0. Copies bytes from the buffer to the array. May block without O_NONBLOCK. Returns
	// * the total number of bytes read.
	// */
