...
public class HaDevice {
	...
	public enum Variable implements ceri.zwave.command.Variable {
		...
		IOPort, // The port to receive connections on from HAD_IOPORT_DEVICE (this is on the serial
				// port)
		...
		LastTimeCheck, // Only for devices that are capable of implementing time this is when the
						// time was last checked
		LastTimeOffset, // For HAD_LAST_TIME_CHECK this is the timezone offset from UTC when the
						// time was last checked
