...
public class SmBusI2cBehavior {
	...
	public void shouldSupport10BitAddress() throws IOException {
		...
		lib.ioctlI2cBytes.assertValues(List.of(new Bytes(0x3bc, 0x10, ByteProvider.of(0xbc), 1)));
	}
	...
	public void shouldProcessNumberWrites() throws IOException {
		...
		lib.ioctlI2cBytes.assertValues( //
			...
			List.of(new Bytes(0x3b, 0, ByteProvider.of(), 0)), //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0xbc), 1)), //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xa5), 2)), //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xb6, 0xa5), 3)));
	}
	...
	public void shouldProcessNumberWritesWithPec() throws IOException {
		...
		lib.ioctlI2cBytes.assertValues( //
			...
			List.of(new Bytes(0x3b, 0, ByteProvider.of(), 0)), // no PEC
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0xbc, 0xe1), 2)), // gen PEC
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xa5, 0x15), 3)), // gen PEC
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xb6, 0xa5, 0x71), 4))); // gen PEC
	}
	...
	public void shouldProcessByteArrayWrites() throws IOException {
		...
		lib.ioctlI2cBytes.assertValues( //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 3, 1, 2, 3), 5)),
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 1, 2, 3), 4)));
	}
	...
	public void shouldProcessByteArrayWritesWithPec() throws IOException {
		...
		smBus.writeI2cBlockData(0x12, 1, 2, 3);
		lib.ioctlI2cBytes.assertValues( //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 3, 1, 2, 3, 0xa1), 6)), // gen PEC
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 1, 2, 3, 0xd6), 5))); // gen PEC
	}

	@Test
	public void shouldProcessNumberReads() throws IOException {
		var lib = initI2c();
		lib.ioctlI2cBytes.autoResponses(ByteProvider.of(0xab), ByteProvider.of(0xab, 0xcd));
		...
		lib.ioctlI2cBytes.assertValues( //
			...
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 1, null, 1)),
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 1, null, 2)), //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xb6, 0xa5), 3),
	...
	public void shouldProcessNumberReadsWithPec() throws IOException {
		...
		lib.ioctlI2cBytes.autoResponses( // different PEC per request, verified
			ByteProvider.of(0xab, 0x91), //
			ByteProvider.of(0xab, 0xa3), //
			ByteProvider.of(0xab, 0xcd, 0x0d), //
			ByteProvider.of(0xab, 0xcd, 0x9f)); //
		Assert.equal(smBus.readByte(), 0xab);
		Assert.equal(smBus.readByteData(0x12), 0xab);
		Assert.equal(smBus.readWordData(0x12), 0xcdab);
		Assert.equal(smBus.processCall(0x12, 0xa5b6), 0xcdab);
		lib.ioctlI2cBytes.assertValues( // no generated PECs
			...
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 1, null, 2)),
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 1, null, 3)), //
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 0xb6, 0xa5), 3),
	...
	public void shouldProcessByteArrayReads() throws IOException {
		...
		lib.ioctlI2cBytes.autoResponses( //
			ByteProvider.of(3, 1, 2, 3), //
			ByteProvider.of(3, 1, 2, 3), //
			ByteProvider.of(1, 2, 3));
		...
		lib.ioctlI2cBytes.assertValues(
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 0x401, null, 1)),
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 3, 4, 5, 6), 5),
	...
	public void shouldProcessByteArrayReadsWithPec() throws IOException {
		...
		i2c.smBusPec(true);
		lib.ioctlI2cBytes.autoResponses( // different PEC per request, verified
			ByteProvider.of(3, 1, 2, 3, 0xf2), //
			ByteProvider.of(3, 1, 2, 3, 0x95), //
			ByteProvider.of(1, 2, 3, 0xcb));
		Assert.array(smBus.readBlockData(0x12), 1, 2, 3);
		Assert.array(smBus.blockProcessCall(0x12, 4, 5, 6), 1, 2, 3);
		Assert.array(smBus.readI2cBlockData(0x12, 3), 1, 2, 3);
		lib.ioctlI2cBytes.assertValues( // no generated PECs
			...
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12, 3, 4, 5, 6), 5),
				new Bytes(0x3b, 0x401, null, 1)),
			List.of(new Bytes(0x3b, 0, ByteProvider.of(0x12), 1), new Bytes(0x3b, 1, null, 4)));
	}
