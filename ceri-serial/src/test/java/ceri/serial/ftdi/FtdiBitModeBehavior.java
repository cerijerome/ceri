...
import ceri.serial.ftdi.FtdiBitMode.LineDirection;
...
public class FtdiBitModeBehavior {
	...
	public void shouldNotBreachEqualsContract() {
		...
		FtdiBitMode eq1 = FtdiBitMode.builder(BITMODE_FT1284).allLines(LineDirection.in)
			.line(LineDirection.out, 0, 2, 5, 7, 8).build();
		FtdiBitMode eq2 = FtdiBitMode.builder(BITMODE_FT1284).allLines(LineDirection.out)
			.line(LineDirection.in, 1, 3, 4, 6).build();
