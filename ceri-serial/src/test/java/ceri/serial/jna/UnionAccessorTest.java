...
public class UnionAccessorTest {
	...
	public void testConstructorIsPrivate() {
		assertPrivateConstructor(UnionAccessor.class);
	}

	@Test
	public void testTypeAccessorByName() {
		Accessor.Typed<TestUnion, TestStruct> byName =
			UnionAccessor.of("struct", u -> u.struct, (u, t) -> u.struct = t);
	...
	public void testTypeAccessorByClass() {
		Accessor.Typed<TestUnion, TestStruct> byClass =
			UnionAccessor.of(TestStruct.class, u -> u.struct, (u, t) -> u.struct = t);
		var union = new TestUnion();
	...
	public void testUbyteAccessor() {
		IntField.Typed<TestUnion> accessor = UnionAccessor.ofUbyte(u -> u.b, (u, b) -> u.b = b);
		var union = new TestUnion();
	...
	public void testUshortAccessor() {
		IntField.Typed<TestUnion> accessor = UnionAccessor.ofUshort(u -> u.s, (u, s) -> u.s = s);
		var union = new TestUnion();
	...
	public void testIntAccessor() {
		IntField.Typed<TestUnion> accessor = UnionAccessor.ofInt(u -> u.i, (u, i) -> u.i = i);
		var union = new TestUnion();
	...
	public void testIntAccessorByName() {
		IntField.Typed<TestUnion> accessor = UnionAccessor.ofInt("i", u -> u.i, (u, i) -> u.i = i);
		var union = new TestUnion();
		accessor.set(union, 0x80000000);
		var ref = ref(union);
		assertEquals(accessor.get(ref), 0x80000000);
