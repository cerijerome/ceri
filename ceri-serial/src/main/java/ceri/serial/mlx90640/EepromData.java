...
public class EepromData extends MlxBuffer {
	 ...
	 */
	private void restoreVddSensorParameters(CalibrationData cal) {
	 ...
	 */
	private void restoreTaSensorParameters(CalibrationData cal) {
	 ...
	 */
	private void restoreOffset(CalibrationData cal) {
		cal.offsetAverage = value(ee(0x2411));
		...
		for (int p = 0, i = 0; i < ROWS; i++) {
			for (int j = 0; j < COLUMNS; j++, p++) {
				...
				cal.pixOsRef[p] = cal.offsetAverage //
	 ...
	 */
	private void restoreOffsetForInterleavedPattern(CalibrationData cal) {
	 ...
	 */
	private void restoreSensitivityAlpha(CalibrationData cal) {
	 ...
	 */
	private void restoreKvCoefficient(CalibrationData cal) {
	 ...
	 */
	private void restoreKtaCoefficient(CalibrationData cal) {
	 ...
	 */
	private void restoreGainCoefficient(CalibrationData cal) {
	 ...
	 */
	private void restoreKsTaCoefficient(CalibrationData cal) {
	 ...
	 * </pre>
	 */
	private void restoreCornerTemperatures(CalibrationData cal) {
	 ...
	 */
	private void restoreKsToCoefficient(CalibrationData cal) {
	 ...
	 */
	private void restoreSensitivityCorrectionCoefficients(CalibrationData cal) {
	 ...
	 */
	private void restoreSensitivityAlphaCp(CalibrationData cal) {
	 ...
	 */
	private void restoreCompensationPixelOffset(CalibrationData cal) {
	 ...
	 */
	private void restoreKvCpCoefficient(CalibrationData cal) {
		int kvScale = ubits(ee(0x2438), 8, 4);
	 ...
	 */
	private void restoreKtaCpCoefficient(CalibrationData cal) {
		int ktaScale1 = ubits(ee(0x2438), 4, 4) + 8;
	 ...
	 */
	private void restoreTgcCoefficient(CalibrationData cal) {
	 ...
	 */
	private void restoreResolutionControlCoefficient(CalibrationData cal) {
