...
public class ControlRegister1 {
	private static final int DEFAULT = 0x1901;
	...
	public static ControlRegister1 ofDefault() {
		return of(DEFAULT);
	}

	public static ControlRegister1 of(int value) {
	...
	public ControlRegister1 value(int value) {
		this.value = value;
		return this;
	}
	...
	public ControlRegister1 startMeasurement(boolean enable) {
