...
public class StatusRegister {
	...
	public static StatusRegister of(int value) {
	...
	public StatusRegister value(int value) {
		this.value = value;
		return this;
	}
	...
	public StatusRegister lastSubPage(SubPage subPage) {
		lastSubPageField.set(this, subPage);
		return this;
	}
