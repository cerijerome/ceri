...
public enum FtdiEepromValue {
	...
	public static final TypeTranscoder.Single<FtdiEepromValue> xcoder =
		TypeTranscoder.single(t -> t.value, FtdiEepromValue.class);
	public final int value;

	private FtdiEepromValue(int value) {
		this.value = value;
	}
}